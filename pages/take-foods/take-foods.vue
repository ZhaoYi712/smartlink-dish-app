										...
										<view class="steps d-flex flex-column">
											<view class="steps__img-column">
												<view class="steps__img-column-item">
													<image src="/static/icon/take/payed.png" v-if="order.orderStatus == '未付款'"></image>
													<image src="/static/icon/take/no-pay.png" v-else></image>
												</view>
												<view class="steps__img-column-item">
													<image src="/static/icon/take/takeing.png" v-if="order.orderStatus == '制作中'"></image>
													<image src="/static/icon/take/no-take.png" v-else></image>
												</view>
												<view class="steps__img-column-item" v-if="order.takeType == '外卖配送'">
													<image
														src="/static/icon/take/distribution.png"
														v-if="order.orderStatus == '配送中' || order.orderStatus == '已送达'"
													></image>
													<image src="/static/icon/take/no-distribution.png" v-else></image>
												</view>
												<view class="steps__img-column-item" v-else>
													<image src="/static/icon/take/receiveing.png" v-if="order.orderStatus == '请取餐'"></image>
													<image src="/static/icon/take/received.png" v-else></image>
												</view>
											</view>
